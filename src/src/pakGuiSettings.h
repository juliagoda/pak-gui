...
class pakGuiSettings : public KConfigSkeleton
{
  public:
    ...
    */
    static
    void setApp_style_name( const QString & v )
    {
      if (!self()->isApp_style_nameImmutable())
        self()->mApp_style_name = v;
    }
    ...
    */
    static
    QString app_style_name()
    {
      return self()->mApp_style_name;
    }

    /**
      Is app_style_name Immutable
    */
    static
    bool isApp_style_nameImmutable()
    {
      return self()->isImmutable( QStringLiteral( "app_style_name" ) );
    }
